...
* OpenShift Virtualization can help you set a strong foundation for traditional workloads, while building skills for the future with a modern application platform.
...
* Discover how virtualization infrastructure continues to evolve.
...
* You receive a VMA report with a tailored proposal for your complete migration including high-level recommendations and design considerations.
