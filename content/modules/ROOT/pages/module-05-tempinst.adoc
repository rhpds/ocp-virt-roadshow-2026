...
+
NOTE: There is a UI bug in OpenShift Virtulization 4.21 that prevents the template from being edited at this stage. It has been reported and will be fixed soon. 
...
+
NOTE: Until the previously mentioned bug is fixed you can modify CPU and Memory on this screen prior to deploying the VM.
