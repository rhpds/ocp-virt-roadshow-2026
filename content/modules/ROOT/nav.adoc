...
** xref:module-01-intro.adoc#virt_perspective[Switch to the Virtualization Perspective]
...
** xref:module-02-mtv.adoc#interactive_demos[Interactive Demos of Advanced Features]
** xref:module-02-mtv.adoc#migration_wrapup[Migration Wrap-Up]
